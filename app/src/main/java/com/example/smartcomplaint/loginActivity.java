...
public class loginActivity extends Activity implements OnClickListener , ServerResponse {
    ...
    public class Task extends AsyncTask<Context, Integer, String> {
        ...
        protected String doInBackground(Context... arg0) {
            String upLoadServerUri = smartcomplaintConfig.LOGIN_URL;
            try {
                response = login();
            } catch (Exception e) {
    ...
    public String login() throws UnsupportedEncodingException {
        ...
        try {
            ...
            URL url = new URL(smartcomplaintConfig.LOGIN_URL);
